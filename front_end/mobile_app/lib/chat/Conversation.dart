...
class _ConversationPageState extends State<ConversationPage> {
    ...
    _overlayEntry = OverlayEntry(
      builder: (context) => Positioned(
        ...
        child: Material(
          elevation: 4.0,
          borderRadius:
              BorderRadius.circular(8), // Add some border radius if needed
          child: Container(
            padding: EdgeInsets.zero,
            decoration: BoxDecoration(
              color:
                  Colors.black, // Set the background color of the menu to black
  ...
  Widget _menuButton(String text) {
    return TextButton(
      ...
      onPressed: () {
        // TODO: Add functionality for each button press
        print('$text pressed');
        _overlayEntry
            ?.remove(); // Optionally remove the menu after a button is pressed
      },
      child: Text(text),
    );
  }
